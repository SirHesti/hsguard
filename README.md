...
### OPTIONS
 ...
 -__ \-d \-\-db sqlite3.db__        <p>>use this "\[PATH/\]sqlite3.db" database__ overwrite: [RCdatabase](#RC-DATABASE)__</p>
 -__ \-b \-\-base \<dir\>__         <p>>basedir for all operations__ overwrite [RCbase](#RC-BASE)__</p>
 ...
 -__ \-x \-\-exclude  \<file\>__    <p>>read a list of excluded files \-\- '#' comment ####__ add this list: [RCexclude](#RC-EXCLUDE)__</p>
 -__ \-\-exclude_add \<file\>__     <p>>add a single file/dir to excludelist__ works too: [RCexadd](#RC-EXADD)__</p>
 ...
 -__ \-s \-\-noscreen__             <p>>In case of UserCMD's like '\-\-list' make screen for output.\
                                    all UserMsg are saved only in the log. to turn off noscreen use \-s\-__ overwrite [RCnoscreen](#RC-NOSCREEN)__</p>
 -__ \-a \-\-ansi on/off/\-/\+__    <p>>Ansicolor at find/info/list \-a\- off \-a=On or only \-a is on\
                                    colors can be tuned in the config file__ overwrite: [RCansicolor](#RC-ANSICOLOR)__</p>
 ...
 -__ \-e \-\-emergency \[OPTIONS\]__  <p>>PANIC,ABORT=\<errorlevel\>,SKIP,COUNT=\<num\>,UPDATE,UPDATEALL__ overwrite: [RCemergency](#RC-EMERGENCY)__\
 ...
 -__ \-\-wbs \<size\>__             <p>>Warning big size Files default is 16GB__ overwrite: [RCwarnbigsize](#RC-WBS)__</p>
...
Ein '#' am Zeilenanfang ist eine Kommentarzeile. Mehr zu diesem Thema__ unter: [Exclude-File](#EXCLUDEFILE)__",
